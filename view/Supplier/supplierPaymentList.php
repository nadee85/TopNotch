<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>View Manage Supplier Payment Detail</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Supplier Payments</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputGrnid">Supplier Payment Id </label>
                                        <input type="text" class="form-control" id="supPayId" placeholder="Enter Supplier Payment Id" name="txtSupPayId" value="<?php // echo $grnid; ?>" >
                                    </div>

                                    <div class="form-group">
                                        <label for="inputTotal">Total </label>
                                        <input type="text" class="form-control" id="total" placeholder="Enter Total " name="txtTotal" value="<?php // echo $total; ?>" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
//                                            }
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Supplier Payment List</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="pane">
                            <?php
