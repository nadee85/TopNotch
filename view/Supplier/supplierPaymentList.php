        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Supplier Payment</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form>
                        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form id="frmSupPayList" action="updateSupPayment" method="POST">
                            <input type="hidden" name="txtSupPayId" id="suppayid"> 
...
<script>
    ...
    function loadList() {
        ...
        ajax.open("GET", "/TopNotch/supplier/loadSupPayments", true);
        ajax.send();
    ...
    $('table tbody').on("click", "#btnView", function () {
        ...
        $("#suppayid").val(currow.find('td:eq(0)').text());
    });
    ...
    $('table tbody').on("click", "#btnDel", function () {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            $.ajax({
                url: "/TopNotch/supplier/deleteSupPay",
                type: "POST",
                dataType: "JSON",
                data: {
                    id: id
