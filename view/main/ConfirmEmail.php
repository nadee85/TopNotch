                        ...
                        <div class="col-lg-4">
                            <div class="contact_form">
                                ...
                                <form id="frmLogin" class="comment_form">
                                    <div>
                                        <div class="form_title">Registered Email</div>
                                    ...
                                    <div>
                                        <button id="verify" type="button" class="comment_button trans_200">Verify</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<div class = "box-body"><h4>Account Activation is Successful.</br>Thank You!</h4></div></div>');
            });
        </script>
    </body>
</html>