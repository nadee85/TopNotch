                        ...
                        <div class="box-body">
                            <div class="contact_form">
                                ...
                                <form id="frmLogin" class="comment_form">
                                    <div>
                                        <div class="course_image"><img src="<?= RESOURCES ?>dist/img/products/19L.png" alt=""></div>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="contact_info">
                            <div class="row">
                                <div class="col-md-6">
                                    <form id="frmLogin" class="comment_form">
                                        <div>
                                            <div class="contact_info_location_title">19L Bottle</div>
                                        </div>
                                        <div>
                                            <div class="contact_info_title">Rs. 180</div>
                                        </div>
                                        <div>
                                            <!--<div class="contact_info_location_title">No of Bottles</div>-->
                                            <div class="row">
                            ...
                            <div>
                                <button  id="sign" type="button" class="comment_button trans_200">Order</button>
                            </div>
