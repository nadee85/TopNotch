...
//                    }
                    ...
                    <!-- form start -->
                    <form role="form" id="frmURegister" action="TopNotch/user/doRegistration" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <button type="submit" name="submitsave" id="btnRegister" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
                </div><!-- /.box -->
