<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            GRN List
            <small>View Manage GRN Detail</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search GRN</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputGrnid">GRN No </label>
                                        <input type="text" class="form-control" id="grnNo" placeholder="Enter GRN No " name="txtGrnNo" value="<?php // echo $grnid; ?>" >
                                    </div>
