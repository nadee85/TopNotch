<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Invoice List
            <small>View Manage Invoice Detail</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputGrnid">Invoice No </label>
                                        <input type="text" class="form-control" id="invoiceNo" placeholder="Enter Invoice No " name="txtInvNo" value="<?php // echo $grnid;   ?>" >
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="cmbCusId">
