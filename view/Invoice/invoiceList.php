        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form id="frmGRNList" action="updateInvoice" method="POST">
                            <input type="hidden" name="txtInv" id="invno"> 
...
<script>
    ...
    function loadList() {
        ...
        ajax.open("GET", "/TopNotch/invoice/loadInvoice", true);
        ajax.send();
    ...
    function dataList(data) {
        ...
        for (var a = 0; a < data.length; a++) {
            ...
            html += "<td>" + data[a].netamount + "</td>";
            html += "<td>" + (data[a].netamount*data[a].discount)/100 + "</td>";
    ...
    $('table tbody').on("click", "#btnDel", function () {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            $.ajax({
                url: "/TopNotch/invoice/deleteInvoice",
                type: "POST",
                dataType: "JSON",
                data: {
                    id: id
