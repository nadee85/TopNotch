<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>View Manage Customer Due Payments </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Sales</a></li>
            <li class="active">Customer Due Payments</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Customer Due Payment</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form>
                        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form id="frmCusDuePayList" action="newCustomerPayment" method="POST">
                            <input type="hidden" name="txtInvNo" id="invNo"> 
...
<script>
    ...
    function loadList() {
        ...
        ajax.open("GET", "/TopNotch/customer/loadCusDuePayments", true);
        ajax.send();
    ...
    function dataList(data) {
        ...
        for (var a = 0; a < data.length; a++) {
            ...
            html += "<td>" + data[a].invoiceAmount + "</td>";
