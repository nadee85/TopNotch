                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cusPayId" name="txtCusPayId" required="">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="invAmount" name="txtInvAmount" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="box">
                            <div class="box-body">
                                <table id="table1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th class="forceWidth">Invoice No</th>
                                            <th class="forceWidth">Invoice Amount</th>
