            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Customer Payments</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputGrnid">Customer Payment Id </label>
                                        <input type="text" class="form-control" id="cusPayId" placeholder="Enter Customer Payment Id" name="txtCusPayId" value="<?php // echo $grnid; ?>" >
                                    </div>
...
//                                            }
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Customer Payment List</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="pane">
                            <?php
